...
Similarly to the :ref:`pin multiplexing option <o-jtag_pin_func>`, the fuse corresponding to this option must be programmed during the very last operation.
...
The fuse corresponding to this option must be programmed after every other fuse, but before the :ref:`pin multiplexing option <o-jtag_pin_func>` or the :ref:`read protection option <o-read_protection>`, since they are located in different Flash words.
